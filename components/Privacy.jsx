            ...
            <div className={styles.main_content}>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    STELAN STUDIOS LTD, 11 Hocken Barns, Stourport-On-Severn,
                    DY13 0TZ.
                  </p>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <p>
                    By email:{" "}
                    <a href="mailto:stelios.kakoliris@yahoo.com">
                      stelios.kakoliris@yahoo.com
                    </a>
                  </p>
                </li>
                <li>
                  <p>
                    By phone number: <a href="tel:07716668568">07716668568</a>
                  </p>
                </li>
              </ul>
            </div>
