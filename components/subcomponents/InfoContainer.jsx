          ...
          <div className={styles.InfoContainer}>
            ...
            <div className={styles.genreContainer}>
              {info.genres.map((genre, index) => {
                return (
                  <p className={styles.genres} key={`${genre}${id}${index}`}>
                    {genre.name}
                    {index < info.genres.length - 1 ? "," : null}
                  </p>
                );
              })}
            </div>
